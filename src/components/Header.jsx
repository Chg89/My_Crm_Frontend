    ...
    <header className="w-full bg-slate-900/80 backdrop-blur-md border-b border-slate-700 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8 text-sm font-medium">
            <a href="#" className="text-cyan-400">Clients</a>
            <a href="#" className="text-slate-300 hover:text-white transition">Dashboard</a>
            <a href="#" className="text-slate-300 hover:text-white transition">Settings</a>
          </nav>
      ...
      {isOpen && (
        <div className="md:hidden bg-slate-800 border-b border-slate-700 px-4 pt-2 pb-4 space-y-1">
          <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-white bg-slate-700">Clients</a>
          <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-slate-300 hover:bg-slate-700">Dashboard</a>
          <a href="#" className="block px-3 py-2 rounded-md text-base font-medium text-slate-300 hover:bg-slate-700">Settings</a>
        </div>
      )}
    </header>
  );
